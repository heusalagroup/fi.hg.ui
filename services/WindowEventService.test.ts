...
describe('WindowEventService', () => {
    ...
    describe('.on', () => {
        ...
        test('can listen raw string events', () => {
        ...
        test('can listen string messages', () => {
        ...
        test('can listen raw string events while listening string events', () => {
        ...
        test('can listen raw string events while listening JSON events', () => {
        ...
        test('can listen JSON messages with a string listener attached', () => {
        ...
        test('can listen string messages with a JSON listener attached', () => {
